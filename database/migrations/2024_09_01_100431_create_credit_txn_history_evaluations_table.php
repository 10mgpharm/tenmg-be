...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('credit_txn_history_evaluations')) {
            Schema::create('credit_txn_history_evaluations', function (Blueprint $table) {
                $table->id();

                $table->string('identifier')->nullable()->unique(); // system generated e.g EVAL-VENDOR_CODE-YEARMONTHDAY-PRIMARY_ID i.e EVAL-10MG-20240901-23
