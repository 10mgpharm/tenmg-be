...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ecommerce_products', function (Blueprint $table) {
            ...
            $table->foreignId('ecommerce_brand_id')->constrained('ecommerce_brands')->nullOnDelete()->index();
            $table->foreignId('thumbnail_file_id')->constrained('files')->nullOnDelete()->index();
