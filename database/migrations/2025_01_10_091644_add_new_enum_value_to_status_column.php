...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('ecommerce_orders', function (Blueprint $table) {
            $table->enum('status_temp', ['PENDING','CONFIRMED','SHIPPED','DELIVERED','CANCELED', 'CART', 'COMPLETED'])->nullable();
        });
    ...
    public function down(): void
    {
        ...
        Schema::table('ecommerce_orders', function (Blueprint $table) {
            $table->enum('status', ['PENDING','CONFIRMED','SHIPPED','DELIVERED','CANCELED', 'CART'])->nullable();
        });
