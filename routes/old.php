...
Route::prefix('v1')->group(function () {
    ...
    // require __DIR__ . '/api/admin.php';      // TODO: Create this file
    // require __DIR__ . '/api/lender.php';     // TODO: Create this file
    // require __DIR__ . '/api/storefront.php'; // TODO: Create this file
    // require __DIR__ . '/api/client.php';     // TODO: Create this file

    // TODO: Once all route files are created, remove all routes below this comment
    // and uncomment the require statements above

    // public routes (Moved to routes/api/auth.php)
    ...
    Route::middleware(['auth:api', 'scope:full'])->group(function () {
        ...
        Route::prefix('virtual-account')->group(function () {
            ...
            Route::get('/wallet/{walletId}', [VirtualAccountController::class, 'getByWallet']);
        });
        ...
        Route::prefix('vendor')->middleware(['roleCheck:vendor'])->group(function () {
            ...
            Route::prefix('wallet')->group(function () {
                ...
                Route::post('/create', [WalletController::class, 'createVendorWallets']);
            });
        ...
        Route::prefix('lender')->name('lender.')->middleware(['roleCheck:lender'])->group(function () {
            ...
            Route::prefix('wallet')->name('wallet.')->group(function () {
                Route::post('/create', [WalletController::class, 'createLenderWallets']);
            });
