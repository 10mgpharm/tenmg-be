...
class WithdrawFundRequest extends FormRequest
{
    ...
    protected function _initialize()
    {
        ...
        $this->wallet = EcommerceWallet::with('bankAccount')
        ...
        if (!$this->wallet && $this->business) {
            $this->wallet = EcommerceWallet::create([
        ...
        $this->bankAccount = $this->wallet->bankAccount;
    }
    ...
    public function authorize(): bool
    {
        ...
        if (
            !($this->user->hasRole('supplier') || $this->user->hasRole('vendor') || $this->user->hasRole('admin')) ||
    ...
    public function failedAuthorization()
    {
        ...
        // If the user does not have the required role (supplier, vendor, or admin), return an "Unauthorized" error
        if (!($this->user->hasRole('supplier') || $this->user->hasRole('vendor') || $this->user->hasRole('admin'))) {
            abort(response()->json([
