...
class EcommerceProductReviewController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->withQueryString()
        ->through(fn(EcommerceProductReview $item) => EcommerceProductReviewResource::make($item->load(['rating', 'product.measurement', 'product.presentation', 'product.variation'])));
