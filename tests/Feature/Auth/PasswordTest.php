...
class PasswordTest extends TestCase
{
    ...
    public function test_forgot_password_with_valid_email(): void
    {
        ...
        $response->assertStatus(Response::HTTP_OK)
            ->assertJson(
                ...
                $json->where('status', __('passwords.sent'))
            );
    ...
    public function test_reset_password_with_valid_data(): void
    {
        ...
        $response->assertStatus(Response::HTTP_OK)
            ->assertJson(
                fn(AssertableJson $json) =>
                $json->where('status', __('passwords.reset'))
            );
    ...
    public function test_reset_password_with_invalid_otp(): void
    {
        ...
        $response->assertStatus(Response::HTTP_UNPROCESSABLE_ENTITY)
            ->assertJson(
                fn(AssertableJson $json) =>
                $json->where('message', __('The OTP provided is incorrect or has expired. Please try again.'))
                    ->has('errors')
